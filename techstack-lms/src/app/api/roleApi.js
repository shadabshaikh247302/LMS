...
// export async function getAllRole() {
//     try {
//         const response = await axios.get('http://localhost:8000/role/getRoles')
//         // Ensure that the response is an array
//         return response.data.data?.Roles || [];
//     } catch (error) {
//         console.error("Error fetching Roles:", error);
...
//     const reqRole = await axios.get('http://localhost:8000/role/getRole')
//     console.log(reqRole.data.data);
// }    
